...
| G5 | **The reason is never consulted** | Suppression depends only on whether the CSP ended the job himself. No reason code — present or future, blaming the customer or anyone else — changes whether it applies. A CSP cannot pick his way out of it. | R1 · R2 · AC-SUP-8 · AC-GRD-3 · MQ-4 |
...
| MQ-4 ⚠️ *AI GENERATED — review* | For every permanent suppression created, whether the CSP submitted the exit himself, and which reason he gave — so a suppression created by an exit he did not submit is detectable, and the spread of reasons CSPs select is visible even though it changes nothing. | G3 · G5 · AC-GRD-2 · AC-GRD-3 |
