// Proves decline-retrigger-prd.html contains exactly the content of
// Decline_Retrigger_Suppression_PRD.md - nothing extra, nothing missing.
// Run after every build:  node build-html.js && node check-parity.js
const fs = require('fs');
const dir = __dirname + '/';
const md = fs.readFileSync(dir + 'Decline_Retrigger_Suppression_PRD.md', 'utf8');
let html = fs.readFileSync(dir + 'decline-retrigger-prd.html', 'utf8');
